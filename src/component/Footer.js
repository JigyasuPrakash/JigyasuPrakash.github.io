...
const myDate = "15th September, 2020"
...
function Footer() {
    return (
        <section className="footer">
            ...
            <a className="iconBox" target="_blank" rel="noopener noreferrer" href="mailto:ask@itsjigyasu.me"><FontAwesomeIcon icon={faEnvelope} color="white" size="lg" /></a>
